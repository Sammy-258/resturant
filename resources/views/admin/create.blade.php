    ...
    <section class="container ">
        ...
        <div class="row pt-4">
            <div class="col-lg-4 m-auto pt-5">
                <form action="/create" method="POST"  class="" style="border: 1px solid rgb(36, 34, 34);border-radius:20px;">
                    @csrf
                    ...
                    <div class="d-block px-4 pb-4">
                        ...
                        <p class="text-center fs-5">Admin Create Page</p>
                        ...
                        <div class="d-block my-2">
                            ...
                            @error('description')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                            <input type="text" class="form-control btn-general" name="description" type="text" placeholder="Enter description Here" value="{{old('description')}}">
                        </div>
                        <div class="d-block my-2">
                            ...
                            @error('price')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                            <input type="text" class="form-control btn-general" name="price" type="text" placeholder="Enter Price Here" value={{old('price')}}>
                        </div>
                        <div class="d-block my-2">
                            ...
                            @error('tags')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                            <input type="text" class="form-control btn-general" name="tags" type="text" placeholder="Enter Tags Here" value="{{old('tags')}}">
                        </div>
