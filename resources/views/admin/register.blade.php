    ...
    <section class="container ">
        ...
        <div class="row py-1">
            <div class="col-lg-5 m-auto pt-3">
                <form action="/store/register" method="POST"  class="shadow" style="border: 1px solid rgb(36, 34, 34);border-radius:20px;">
                    @csrf
                    ...
                    <div class="d-block px-4 pb-4">
                        ...
                        <p class="text-center fs-4" >Registration Page</p>
                        <div class="d-block my-2">
                            <label for="">Name:</label><br>
                            @error('name')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                            <input type="text" class="form-control btn-general" name="name" type="text" placeholder="Enter Name Here" value="{{old('name')}}">
                        </div>
                        <div class="d-block my-2">
                        ...
                        <div class="d-block my-2">
                            ...
                            @error('password_confirmation')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                            <input type="password" class="form-control btn-general" name="password_confirmation" placeholder="Enter password Here" value="{{old('password_confirmation')}}">
                        </div>
                        <button class="btn btn-general form-control py-2 mt-4 text-light" type="submit" style="background-color: rgb(26, 6, 6);">Sign Up</button>

                        <div class="d-block pt-4">
                            <p class="text-center">Already have an account? <a href="/admin/login" style="text-decoration: none;color:brown;">Login Here</a></p>
                        </div>
                    </div>
                </form>
            </div>
